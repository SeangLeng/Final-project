...
export default function Navbar() {
    const getuser = secureLocalStorage.getItem("user" || null)
            ...
            <div>
                ...
                <div id="dropdownNavbar" class=" z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                    <ul class="py-2 text-sm text-gray-700  bg-blue-800  dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                        ...
                        <li>
                            <a href="/login" class="block px-4 py-2 text-white  hover:bg-gray-400  dark:hover:bg-gray-600">Log - in</a>
                        </li>
                        <li>
    ...
    console.log(url)
    if (check.pathname !== "/login" && check.pathname !== "/login/signIn" && check.pathname !== "/login/forgetPassword")
        return (
            <nav className="bg-white dark:bg-gray-900 px-5 fixed w-full z-30 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
                <div className=" flex flex-wrap items-center justify-between pr-4">
                    ...
                    <div class="hidden w-full md:flex justify-center items-center gap-5 md:w-auto" id="navbar-default">
