...
export default function Navbar() {
            ...
            <div>
                ...
                <div id="dropdownNavbar" className=" z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                    <ul className="py-2 text-sm text-gray-700  bg-blue-800  dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                        ...
                        <li>
                            <button onClick={resetUser} className="block px-4 py-2 text-white  hover:bg-gray-400  dark:hover:bg-gray-600">Log - out</button>
                        </li>
                    </ul>
                </div>
    ...
    console.log(url)
    if (check.pathname !== "/login" && check.pathname !== "/login/signIn" && check.pathname !== "/login/forgetPassword" && check.pathname !== "/login/istadLogin")
        return (
